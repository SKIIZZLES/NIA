...
const ff: TranslationKeys = {
  ...
  create: {
    title: 'Taggu',
    subtitleMock: 'Mbayliigu demo: winndannde maa heddoo e kaɓirgal ngal.',
    subtitleSupabase: 'Winndannde maa ara e fil NIA.',
    ...
    publish: 'Yaltin',
    publishedMockTitle: 'Winndaama e mbayliigu demo',
    publishedTitle: 'Yaltinaama',
    publishedMockBody: 'Ɓeydaama e feed nokkuure «Ngam maa».',
    publishedBody: 'Winndannde maa ena e enternet. Yiylo nde e fil e profiil maa.',
    ...
    film: 'Natal video',
    filmHint: 'Widewo jooni walla suɓo fiilde e galeri maa.',
    alertCamera: 'Kamera',
