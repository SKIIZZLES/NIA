...
const ig: TranslationKeys = {
  ...
  auth: {
    ...
    supabaseRegisterHint: 'Ndebanye aha Supabase Auth. A na-emepụta profaịlụ na-akpaghị aka (SQL trigger). Gbanyụọ «Confirm email» na Auth → Providers iji nwaa n\'enweghị ozi-e.',
    authMockBadge: 'AUTH MOCK MVP',
