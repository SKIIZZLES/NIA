...
const ln: TranslationKeys = {
  ...
  create: {
    title: 'Kosala',
    subtitleMock: 'Lolenge ya démo: eloko otindi etikali na esaleli oyo.',
    subtitleSupabase: 'Eloko otindi ekomonana na fil ya NIA.',
    ...
    publish: 'Publier',
    publishedMockTitle: 'Etindami na lolenge ya démo',
    publishedTitle: 'Epublier',
    publishedMockBody: 'Bakisi na feed ya local «Pona yo».',
    publishedBody: 'Eloko otindi ezali na internet. Luka yango na fil mpe na profil na yo.',
    ...
    film: 'Kanga vidéo',
    filmHint: 'Kamata vidéo sikoyo to pona fichier na galerie na yo.',
    alertCamera: 'Camera',
