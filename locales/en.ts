...
const en: TranslationKeys = {
  ...
  camera: {
    ...
    permissionDenied: 'Camera access is denied. Open your phone settings to allow it.',
    allow: 'Allow camera',
    openSettings: 'Open settings',
    micDenied: 'Microphone not allowed: the video will be recorded without sound.',
    ...
    mountErrorTitle: 'Camera unavailable',
    mountErrorBody: 'The NIA camera could not start. Opening the phone camera.',
  },
  create: {
    title: 'Create',
