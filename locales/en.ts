...
const en: TranslationKeys = {
  ...
  create: {
    ...
    hubTitle: 'Create',
    hubSubtitle: 'What do you want to share today?',
    hubVideo: 'Video',
    hubVideoDesc: 'Record or choose a video',
    hubPhoto: 'Photo',
    hubPhotoDesc: 'Take or choose a photo',
    hubText: 'Text',
    hubTextDesc: 'Text post',
    hubLive: 'Live',
    hubLiveDesc: 'Schedule a live (prep)',
    hubEvent: 'Event',
    hubEventDesc: 'Announce an event',
    hubSoon: 'Soon',
    titleVideo: 'Publish a video',
    titlePhoto: 'Publish a photo',
