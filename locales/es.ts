...
const es: TranslationKeys = {
  ...
  camera: {
    ...
    permissionBody: 'NIA necesita la cámara para grabar tu vídeo.',
    permissionDenied: 'El acceso a la cámara está denegado. Abre los ajustes del teléfono para permitirlo.',
    allow: 'Permitir la cámara',
    openSettings: 'Abrir los ajustes',
    micDenied: 'Micrófono no permitido: el vídeo se grabará sin sonido.',
    ...
    recordFailed: 'La grabación ha fallado. Inténtalo de nuevo.',
    mountErrorTitle: 'Cámara no disponible',
    mountErrorBody: 'La cámara de NIA no ha podido iniciarse. Se abrirá la cámara del teléfono.',
  },
  create: {
    title: 'Crear',
    ...
    filmHintVideo: 'Galería de vídeo o cámara. Portada opcional para el perfil.',
    filmHintPhoto: 'Galería de fotos o cámara.',
    errWrongMediaVideo: 'Selecciona un vídeo para este modo.',
  ...
  events: {
    ...
    loadFail: 'No se han podido cargar los eventos.',
    notFound: 'Evento no encontrado.',
    attend: 'Asistir',
    attending: 'Voy',
    attendFail: 'No se ha podido actualizar tu asistencia.',
    share: 'Compartir',
    ...
    fieldDescriptionPlaceholder: 'Ambiente, cartel, qué esperar…',
    ...
    publishFail: 'No se ha podido publicar',
  ...
  live: {
    ...
    fieldTitle: 'Título',
    fieldTitlePlaceholder: 'Ej. Sesión Afrobeat en directo',
  ...
  search: {
    title: 'Buscar',
    placeholder: 'Personas, vídeos, sonidos, #hashtags, eventos…',
    ...
    loadFail: 'No se ha podido realizar la búsqueda.',
  ...
  series: {
    ...
    loadFail: 'No se ha podido cargar la serie.',
    emptyEpisodes: 'Todavía no hay episodios. Añade un vídeo desde el menú «…».',
    ...
    removeEpisodeBody: 'El vídeo seguirá en tu perfil, pero saldrá de esta serie.',
    removeEpisode: 'Quitar',
    deleteTitle: '¿Eliminar la serie?',
    deleteBody: 'Los vídeos no se borrarán — solo desaparece la serie.',
    delete: 'Eliminar la serie',
    addedTitle: 'Añadido a la serie',
    addedBody: '«%{title}» ya incluye este vídeo.',
    missingVideo: 'Falta el vídeo.',
  },
  filter: {
    label: 'Filtros NIA',
